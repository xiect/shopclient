...
public class BaseUtil
{
     ...
     *  模块warning日志
     */
    public static void w( String s, String module )
    {
        Log.w( getAppTag() + module + "WARNING:", s );
    }
     ...
     *  Log.eのラッパ
     */
    public static void e(Exception e, String s, String module )
    {
        Log.e( getAppTag() + module, s+"Exception:"+e.getMessage() );
    }
