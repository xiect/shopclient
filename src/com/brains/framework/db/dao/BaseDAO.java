package com.brains.framework.db.dao;

import java.util.List;

import com.brains.framework.common.FWUtil;
import com.brains.framework.db.DBHelper;
import com.brains.framework.db.entity.BaseLogicalEntity;
...
TODO: find系のメソッドでgetConcreteGenericType()しても，返却値は下記のようになってしまう。子クラスが取れず。orz
    ...
    07-26 15:32:32.515: DEBUG/android-mvc-sample(3191):   エンティティクラスの型：com.brains.framework.db.entity.BaseLogicalEntity
    07-26 15:32:32.525: DEBUG/android-mvc-sample(3191): com.brains.framework.db.dao.Finder#findAll :
    07-26 15:32:32.525: DEBUG/android-mvc-sample(3191):   DB接続をオープンします。
    07-26 15:32:32.525: ERROR/android-mvc-sample(3191): java.lang.InstantiationException: com.brains.framework.db.entity.BaseLogicalEntity
